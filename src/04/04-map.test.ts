...
import {getStreetsTitlesOfGovermentsBuildings, getStreetTitlesOfHouses, createMessage} from "./04-map";
...
test('create greeting messages for street', () => {
    ...
    expect(messages[0]).toBe('Hello my friends from White street')
    expect(messages[1]).toBe('Hello my friends from Happy street')
    expect(messages[2]).toBe('Hello my friends from Happy street')
})